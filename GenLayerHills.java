        ...
        for (int var7 = 0; var7 < par4; ++var7)
        {
            for (int var8 = 0; var8 < par3; ++var8)
            {
                ...
                if (this.nextInt(3) == 0)
                {
                    ...
                    {
                        var10 = BiomeGenBase.oasis.biomeID;
                    }
                    ...
                    else if (var9 == BiomeGenBase.glacier.biomeID)
                    {
                    	var10 = BiomeGenBase.glacierhills.biomeID;
                    }
                    else if (var9 == BiomeGenBase.sandyHills.biomeID)
                    {
                    	var10 = BiomeGenBase.oasis.biomeID;
                    }
                    else if (var9 == BiomeGenBase.firelands.biomeID)
                    {
                    	var10 = BiomeGenBase.volcano.biomeID;
                    }
                    else if (var9 == mod_biomes.newdesert.biomeID)
                    {
                    	var10 = BiomeGenBase.oasis.biomeID;
                    }
                    else if (var9 == BiomeGenBase.mountains.biomeID)
                    {
                    	var10 = mod_biomes.coveredmountains.biomeID;
                    }
                    else if (var9 == mod_biomes.newforest.biomeID)
                    {
                    	var10 = mod_biomes.foresthills.biomeID;
                    }
                    else if (var9 == mod_biomes.pineforest.biomeID)
                    {
                    	var10 = mod_biomes.pineforesthills.biomeID;
                    }
                    if (var10 == var9)
                    {
