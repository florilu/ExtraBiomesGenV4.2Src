...
import net.minecraft.src.structures.*;
...
public class BiomeDecorator
{
    ...
    protected int testperchunk;
	public Test testgen;
	
	public int acaciaperchunk;
	public WorldGenAcaciaTree acaciagen;
    ...
    public BiomeDecorator(BiomeGenBase par1BiomeGenBase)
    {
        ...
        this.testgen = new Test();
        this.testperchunk = 0;
        this.acaciagen = new WorldGenAcaciaTree();
        this.acaciaperchunk = 0;
    ...
    protected void decorate()
    {
        ...
        for(int g1 = 0; g1 < acaciaperchunk; g1++)
        {
        	int g2 = chunk_X + randomGenerator.nextInt(16) + 8;
        	int g3 = chunk_Z + randomGenerator.nextInt(16) + 8;
        	acaciagen.generate(currentWorld, randomGenerator, g2, currentWorld.getHeightValue(g2, g3), g3); 
        }
        for(int g1 = 0; g1 < bigpineperchunk; g1++)
        {
        	int g2 = chunk_X + randomGenerator.nextInt(16) + 8;
        	int g3 = chunk_Z + randomGenerator.nextInt(16) + 8;
        	bigpinegen.generate(currentWorld, randomGenerator, g2, currentWorld.getHeightValue(g2, g3), g3); 
        }
        for(int g1 = 0; g1 < testperchunk; g1++)
        {
        	int g2 = chunk_X + randomGenerator.nextInt(16) + 8;
        	int g3 = chunk_Z + randomGenerator.nextInt(16) + 8;
        	testgen.generate(currentWorld, randomGenerator, g2, currentWorld.getHeightValue(g2, g3), g3); 
        }
