...
public abstract class BiomeGenBase
{
    ...
    /**ExtraBiomesGen Mod Biomes */
    public static final BiomeGenBase primeval = (new Primeval(23)).setColor(5470985).setBiomeName("Primeval Forest").setTemperatureRainfall(1.2F, 0.9F).setMinMaxHeight(0.2F, 0.3F);
    public static final BiomeGenBase endbiome = (new EndBiome(24)).setColor(8421631).setBiomeName("Endbiome").setDisableRain();
    public static final BiomeGenBase epicmountains = (new EpicMountains(25)).setColor(5470985).setBiomeName("Epic Mountains").setTemperatureRainfall(0.9F, 0.9F).setMinMaxHeight(0.0F, 20.0F);
    public static final BiomeGenBase glacier = (new Glacier(26)).setColor(747097).setBiomeName("Glacier").setTemperatureRainfall(0.0F, 0.0F).setMinMaxHeight(0.1F, 0.1F); //Smooth
    public static final BiomeGenBase glacierhills = (new Glacier(27)).setColor(747097).setBiomeName("Glacier").setTemperatureRainfall(0.0F, 0.0F).setMinMaxHeight(0.1F, 2.0F);
    public static final BiomeGenBase lakeland = (new Lakeland(28)).setColor(5470985).setBiomeName("Lakelands").setTemperatureRainfall(0.8F, 1.0F).setMinMaxHeight(-0.3F, 0.1F);
    public static final BiomeGenBase meadow = (new Meadow(29)).setColor(5470985).setBiomeName("Meadow").setTemperatureRainfall(1.0F, 1.0F).setMinMaxHeight(0.1F, 0.2F);
    public static final BiomeGenBase mixed = (new Mixed(30)).setColor(353825).setBiomeName("Mixed Forest").setTemperatureRainfall(0.9F, 0.7F).setMinMaxHeight(0.2F, 0.4F);
    public static final BiomeGenBase mixedSnow = (new MixedSnow(31)).setColor(747097).setBiomeName("Snowy Mixed Forest").setTemperatureRainfall(0.1F, 0.7F).setMinMaxHeight(0.2F, 0.4F);
    public static final BiomeGenBase oasis = (new Oasis(32)).setColor(16421912).setBiomeName("Oasis").setTemperatureRainfall(0.9F, 1.0F).setMinMaxHeight(-0.1F, 0.3F);
    public static final BiomeGenBase sandyHills = (new SandyHills(33)).setColor(13786898).setBiomeName("Sandy Hills").setDisableRain().setTemperatureRainfall(2.0F, 0.0F).setMinMaxHeight(0.1F, 2.0F);
    public static final BiomeGenBase savanna = (new Savanna(34)).setColor(13786898).setBiomeName("Savanna").setDisableRain().setTemperatureRainfall(2.0F, 0.0F).setMinMaxHeight(0.1F, 0.2F);
    public static final BiomeGenBase table = (new Table(35)).setColor(353825).setBiomeName("Table Mountains").setTemperatureRainfall(0.8F, 1.0F).setMinMaxHeight(3.0F, 3.0F);
    public static final BiomeGenBase firelands = (new Firelands(36)).setColor(13786898).setBiomeName("Firelands").setDisableRain().setTemperatureRainfall(1.0F, 0.0F).setMinMaxHeight(0.3F, 0.4F);
    public static final BiomeGenBase volcano = (new Volcano(37)).setColor(13786898).setBiomeName("Volcano").setDisableRain().setTemperatureRainfall(1.0F, 0.0F).setMinMaxHeight(0.4F, 0.8F);
    public static final BiomeGenBase wasteland = (new Wasteland(38)).setColor(13786898).setBiomeName("Wasteland").setDisableRain().setTemperatureRainfall(2.0F, 0.0F).setMinMaxHeight(0.1F, 0.3F);
    public static final BiomeGenBase mountains = (new Mountains(40)).setColor(747097).setBiomeName("Mountains").setTemperatureRainfall(0.9F, 1.0F).setMinMaxHeight(0.4F, 1.5F);
