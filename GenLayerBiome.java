...
{
    public static BiomeGenBase[] biomeArray = new BiomeGenBase[] {BiomeGenBase.desert, BiomeGenBase.forest, BiomeGenBase.extremeHills, BiomeGenBase.swampland, BiomeGenBase.plains, BiomeGenBase.taiga, BiomeGenBase.jungle, BiomeGenBase.primeval};
    ...
    public GenLayerBiome(long par1, GenLayer par3GenLayer, WorldType par4WorldType)
    {
        ...
        if (par4WorldType == WorldType.DEBUG)
        {
        	this.allowedBiomes = new BiomeGenBase[] {mod_biomes.pineforest};
        }
        
        if (par4WorldType == WorldType.EXTRA)
        {
        	this.allowedBiomes = new BiomeGenBase[] {BiomeGenBase.primeval, BiomeGenBase.endbiome, BiomeGenBase.epicmountains, BiomeGenBase.glacier, BiomeGenBase.lakeland, BiomeGenBase.meadow, BiomeGenBase.mixed, BiomeGenBase.mixedSnow, BiomeGenBase.sandyHills, BiomeGenBase.savanna, BiomeGenBase.table, BiomeGenBase.firelands, BiomeGenBase.wasteland, mod_biomes.newdesert, BiomeGenBase.mountains, mod_biomes.newforest};
        }
    }
